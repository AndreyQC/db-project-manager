...
> Предшественник (история обсуждения): `-=tasks=-/phase_14/Phase_14_vision_draft.md`.
...
- `-=tasks=-/phase_14/Phase_14_vision_final.md` — нормативный дизайн
- `-=tasks=-/phase_14/Phase_14_vision_draft.md` — история обсуждения
