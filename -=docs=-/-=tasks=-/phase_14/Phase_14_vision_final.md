...
>
> Предыдущий артефакт: `-=tasks=-/phase_14/Phase_14_vision_draft.md` (не удаляется —
...
- [ ] §12: `git add -- "-=docs=-/-=tasks=-/phase_14/..."`.
...
- `-=tasks=-/phase_14/Phase_14_vision_draft.md` — предшествующий драфт (история обсуждения)
