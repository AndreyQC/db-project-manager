...
> Контекст:
> - `-=docs=-/-=tasks=-/phase_07/Phase_7_vision_draft.md` — история обсуждения (USER_INPUT U1–U7)
> - `-=docs=-/-=CHECKPOINTS=-/20260720_004_checkpoint.md` — снапшот проекта на старте фазы
