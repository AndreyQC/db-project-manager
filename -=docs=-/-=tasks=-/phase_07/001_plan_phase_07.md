...
>
> Контекст:
> - `-=docs=-/-=tasks=-/phase_07/Phase_7_vision_final.md` — нормативный дизайн (источник решений, §1-14)
> - `-=docs=-/-=tasks=-/TASK_CONVENTIONS.md` — правила коммитов, цикл plan → result
...
в одном коммите. `git add -- "-=docs=-/..."` (LESSONS §12).
...
1. `-=docs=-/-=tasks=-/phase_07/002_result_phase_07.md` — что сделано,
...
3. `-=docs=-/-=CHECKPOINTS=-/<YYYYMMDD>_NNN_checkpoint.md` — «Phase 7
   ...
   тестов.
4. `-=docs=-/-=PHASES=-/Phase_07.md` — свод фазы (PHASES_CONVENTION).
