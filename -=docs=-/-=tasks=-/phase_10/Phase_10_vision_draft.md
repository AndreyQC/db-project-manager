...
> - `-=tasks=-/ROADMAP.md` §9 — USER_INPUT Q3 (pre/post идемпотентность), Q4 (git-tag vs commit), Q5 (migrations/ location)
...
- [ ] §12: `git add -- "-=docs=-/-=tasks=-/phase_10/..."` — дефис в имени каталога `-=docs=-`.
...
- `-=CHECKPOINTS=-/20260804_001_checkpoint.md` — текущее состояние (Phase 14 done)
- `-=tasks=-/ROADMAP.md` §2 (порядок), §4 (CD-1..CD-5), §7 (правила безопасности), §8 (пайплайн), §9 (Q3/Q4/Q5)
...
- `-=tasks=-/phase_14/Phase_14_vision_draft.md` — образец структуры draft (этот файл сделан по нему)
