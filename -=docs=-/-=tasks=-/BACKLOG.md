...
См. `-=tasks=-/phase_08/Phase_8_result.md`, `-=PHASES=-/Phase_08.md`. Follow-up: колонки и
...
**Связано:** `-=tasks=-/phase_08/Phase_8_result.md` §5; `infrastructure/parsing/overload_resolution.py`.
...
**Связано:** `-=tasks=-/phase_08/Phase_8_result.md` §5.
