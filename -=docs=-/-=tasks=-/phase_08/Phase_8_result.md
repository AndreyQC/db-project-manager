...
>
> Норматив-дизайн: `-=tasks=-/phase_08/Phase_8_vision_final.md`.
> План: `-=tasks=-/phase_08/Phase_8_plan.md` (шаги P8.S1–P8.S8).
...
- `-=tasks=-/phase_08/Phase_8_plan.md` — пошаговый план (P8.S1–S8)
- `-=tasks=-/phase_08/Phase_8_vision_draft.md` — история обсуждения
