...
>
> Контекст:
> - `_docs_/_tasks_/2026-07-28/20260728_001_compare_db_vs_fs_draft.md` — нормативный дизайн (источник решений, §1-9)
> - `_docs_/_tasks_/TASK_CONVENTIONS.md` — цикл plan → result, правила коммитов
...
`git add -- "_docs_/..."` для путей с `-` (LESSONS §12).
...
1. `_docs_/_tasks_/phase_09/002_result_phase_09.md` — что сделано, проверки,
...
3. `_docs_/_checkpoints_/<YYYYMMDD>_NNN_checkpoint.md` — «Phase 9 complete»:
...
4. `_docs_/_phases_/Phase_09.md` — свод фазы (PHASES_CONVENTION).
5. `_docs_/_tasks_/BACKLOG.md` — добавить edge diff (P2, из draft §6).
...
- В `phase_09/` есть план (этот файл) и result; draft сохранён для истории
  (`_tasks_/2026-07-28/20260728_001_..._draft.md`).
