...
> **Дата:** 2026-08-15
> **Ветка:** dev
> **Статус:** draft → закрыт (все `USER_INPUT` ALT-1..ALT-8 закрыты; нормативный дизайн —
> `Phase_12_vision_final.md`, этот файл остаётся историей обсуждения)
>
> Контекст:
...
### ALT-8. Механика засева данных репетиционной БД — ЗАКРЫТО: вариант (a) seed-скрипты
**Решение (выбрано пользователем):** пользовательские seed-скрипты. Опциональный каталог
