...
>
> Предшествующий артефакт: `_tasks_/phase_11/Phase_11_vision_draft.md` (не удаляется — остаётся
> для истории обсуждения, по TASK_CONVENTIONS §2.2).
>
> Контекст:
> - `_checkpoints_/20260814_001_checkpoint.md` — текущее состояние (Phase 10 done)
> - `_tasks_/ROADMAP.md` §2 (шаг 3), §3 (safety principle), §4 (CD-6..CD-10), §7 (правила), §8 (пайплайн)
> - `_tasks_/phase_10/Phase_10_vision_final.md` — фундамент (versioning, `__deploy`, runner)
> - `_phases_/Phase_09.md` — compare (fundament CD-6)
...
- [ ] §12: `git add -- "_docs_/_tasks_/phase_11/..."` (дефис в `_docs_`).
...
- `_tasks_/phase_11/Phase_11_vision_draft.md` — предшествующий драфт (история обсуждения)
- `_tasks_/ROADMAP.md` §2 (шаг 3), §4 (CD-6..CD-10), §7 (правила), §8 (пайплайн шаги 2-3)
- `_tasks_/phase_10/Phase_10_vision_final.md` — фундамент (versioning, `__deploy`, runner)
- `_phases_/Phase_09.md` — compare (движок дельты для CD-6)
