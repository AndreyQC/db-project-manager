...
>
> Контекст:
> - `_tasks_/phase_11/Phase_11_vision_final.md` — нормативный дизайн (SG-0..SG-7, SG-M)
> - `_tasks_/phase_11/Phase_11_plan.md` — пошаговый план
> - `_checkpoints_/20260814_001_checkpoint.md` — состояние до фазы (Phase 10 done)
...
- `_tasks_/phase_11/Phase_11_vision_final.md` — решения SG-0..SG-7/SG-M
- `_tasks_/ROADMAP.md` §2 (шаг 4 — Phase 12 следующая)
