...
>
> Норматив-дизайн: `_tasks_/phase_11/Phase_11_vision_final.md`.
> Предшественник (история обсуждения): `_tasks_/phase_11/Phase_11_vision_draft.md`.
...
5. Документы фазы (каждый — отдельный коммит, TASK_CONVENTIONS §6):
   - `_tasks_/phase_11/Phase_11_result.md` — результат, коммиты, известные ограничения.
   - `_phases_/Phase_11.md` — свод фазы.
   - `_checkpoints_/<date>_001_checkpoint.md` — сессионный снапшот.
...
- [ ] §12: `git add -- "_docs_/_tasks_/phase_11/..."`.
...
- `_tasks_/phase_11/Phase_11_vision_final.md` — нормативный дизайн (источник решений).
- `_tasks_/phase_11/Phase_11_vision_draft.md` — история обсуждения (USER_INPUT SG-1..SG-7).
- `_tasks_/phase_10/Phase_10_plan.md` — образец структуры и процесс реализации.
- `_checkpoints_/20260814_001_checkpoint.md` — текущее состояние (Phase 10 done).
- `_tasks_/ROADMAP.md` §2/§4 (CD-6..CD-10)/§7/§8.
