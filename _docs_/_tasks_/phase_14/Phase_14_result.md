...
>
> Контекст:
> - План: `_tasks_/phase_14/Phase_14_plan.md`
> - Норматив-дизайн: `_tasks_/phase_14/Phase_14_vision_final.md`
> - История: `_tasks_/phase_14/Phase_14_vision_draft.md`
> - Чекпойнт предыдущий: `_checkpoints_/20260731_001_checkpoint.md` (Phase 8 done)
...
1. `_tasks_/phase_14/Phase_14_vision_final.md` — нормативный дизайн (закрытые DV-1..DV-7)
2. `_tasks_/phase_14/Phase_14_plan.md` — пошаговый план
3. `_phases_/Phase_14.md` — свод фазы
