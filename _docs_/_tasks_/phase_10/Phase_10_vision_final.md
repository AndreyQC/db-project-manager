...
>
> Предыдущий артефакт: `_tasks_/phase_10/Phase_10_vision_draft.md` (не удаляется —
...
- `_tasks_/phase_10/Phase_10_vision_draft.md` — предшествующий драфт (история обсуждения)
- `_checkpoints_/20260804_001_checkpoint.md` — текущее состояние (Phase 14 done)
- `_tasks_/ROADMAP.md` §2 (порядок), §4 (CD-1..CD-5), §7 (правила безопасности), §8 (пайплайн)
