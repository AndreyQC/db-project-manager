...
> Контекст:
> - `_tasks_/phase_00/001_analysis_existing_code.md` — анализ POC
> - `_tasks_/phase_00/002_idea.md` — видение
> - `_tasks_/phase_00/003_roadmap_migration.md` — целевая архитектура и фазы
>
> Дата: 2026-07-17
