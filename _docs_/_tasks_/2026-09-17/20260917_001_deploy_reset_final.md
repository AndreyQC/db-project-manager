# deploy reset — сброс пользовательских схем целевой БД (final)

> **Дата:** 2026-09-17
> **Статус:** final — все решения закрыты пользователем 2026-09-17 (D1–D4, D5, D9,
> планирование — Phase 18); реализация начата в тот же день по решению пользователя.
> История обсуждения и хронология решений — в `20260917_001_deploy_reset_draft.md`.
>
> Контекст:
