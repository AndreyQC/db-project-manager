...
> Контекст:
> - `_tasks_/phase_02/Phase_2_vision_final.md` — зафиксированное видение (все решения Q1–Q8)
> - `_tasks_/phase_00/003_roadmap_migration.md` — целевая архитектура
...
**Файлы:** `pyproject.toml` (+testcontainers в dev), `tests/integration/conftest.py`, `tests/integration/test_deploy_validate_e2e.py`, `tests/integration/test_graph_build_e2e.py`, `README.md`, `_tasks_/phase_00/003_roadmap_migration.md` (обновить).
