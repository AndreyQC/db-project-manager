...
>
> Контекст:
> - `_tasks_/phase_05/Phase_5_vision_draft.md` — история обсуждения (альтернативы Q1–Q8)
> - `_checkpoints_/20260720_001_checkpoint.md` — состояние после Phase 4
> - `_tasks_/BACKLOG.md` — P1 (extensions end-to-end), P2 (integration test)
> - `_tasks_/TASK_CONVENTIONS.md`
> - `LESSONS_LEARNED.md`
