...
> **Предшественник:** `_docs_/_tasks_/2026-07-29/20260729_001_compare_gui_action_draft.md`
> (draft сохранён для истории обсуждения — TASK_CONVENTIONS §2.2)

> Контекст:
> - `_docs_/_checkpoints_/20260729_001_checkpoint.md` — Phase 9 closed (compare CLI)
> - `_docs_/_tasks_/phase_07/Phase_7_vision_final.md` — action registry (норматив)
> - `_docs_/_tasks_/2026-07-28/20260728_001_compare_db_vs_fs_draft.md` — compare CLI дизайн
