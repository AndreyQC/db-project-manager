...
>
> Контекст:
> - `_docs_/_tasks_/2026-07-29/20260729_002_compare_gui_action_final.md` — нормативный дизайн
> - `_docs_/_tasks_/2026-07-29/20260729_001_compare_gui_action_draft.md` — история обсуждения
> - `_docs_/_tasks_/phase_09/002_result_phase_09.md` — результат CLI-реализации compare (Phase 9)
